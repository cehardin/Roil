...
public class DomainMismatchException extends Exception {
    ...
    public DomainMismatchException(String message) {
        super(message);
    }

    public DomainMismatchException(String message, Throwable cause) {
        super(message, cause);
    }

    public DomainMismatchException(Throwable cause) {
        super(cause);
    }
